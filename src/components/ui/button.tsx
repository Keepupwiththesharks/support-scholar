  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97] hover:scale-[1.02]",
  {
    variants: {
      variant: {
        ...
        gradient: "gradient-primary text-primary-foreground shadow-md hover:shadow-glow hover:scale-[1.03] active:scale-[0.98]",
        recording: "bg-destructive text-destructive-foreground shadow-recording animate-pulse-recording hover:bg-destructive/90",
      ...
      size: {
        ...
        "icon-sm": "h-8 w-8 hover:scale-110 active:scale-95",
        "icon-lg": "h-12 w-12 hover:scale-110 active:scale-95",
      },
    },
    defaultVariants: {
      variant: "default",
